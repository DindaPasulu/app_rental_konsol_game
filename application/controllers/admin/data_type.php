...
class data_type extends CI_Controller{
    ...
    public function tambah_type_aksi()
    {
        ...
        if($this->form_validation->run() == FALSE){
            ...
            $this->session->set_flashdata('message','<div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Data Type Game Console Berhasil Ditambahkan! </strong>
    ...
    public function update_type_aksi()
    {
        ...
        $this->session->set_flashdata('message','<div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Data Type Game Console Berhasil Di Update! </strong>
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>');
    ...
    public function delete_type($id)
    {
        ...
        $this->session->set_flashdata('message','<div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Data Type Game Console Berhasil Dihapuskan! </strong>
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>');
